...
Be sure to mention the GitHub issue you're fixing if one was already open. Pull requests that are generated by AI tools are not allowed.

## AI usage

Contributions must be authored by humans. The use of AI-generated code is not discouraged for this project, unless minimal and proofread. By submitting a contribution, you confirm that the work is your own and was not generated, in whole or in part, by AI tools.
