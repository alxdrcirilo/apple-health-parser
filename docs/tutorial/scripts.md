...
- `apple-health-parser-cli`: A script to export data from the Apple Health export file to CSV files
- `apple-health-parser-year-recap`: A script to generate a year recap of the Apple Health data

## Running the CLI export script

The CLI export script comes with a help command that lists all available options and commands:
